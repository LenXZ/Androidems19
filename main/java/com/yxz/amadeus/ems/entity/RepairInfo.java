...
public class RepairInfo extends HashMap<String, Account> implements Parcelable {
    ...
    public RepairInfo(String infoID, String deviceID,String deviceName, String damageDate, String damageDegree, String damageCause, String repairDate,
