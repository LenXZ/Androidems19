package com.yxz.amadeus.ems.Table;
    ...
    public void setListener() {
        ...
        leftListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //跳转界面
                Toast.makeText(TableActivity.this, "打开某条记录的单独详情L"+id+"_"+position, Toast.LENGTH_SHORT).show();
            }
        });
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //跳转界面
                Toast.makeText(TableActivity.this, "打开某条记录的单独详情R"+id+"_"+position, Toast.LENGTH_SHORT).show();
            }
        });
    }
