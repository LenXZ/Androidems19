...
public class In_CheckInfo extends AppCompatActivity {
    private Spinner state1, state0;
    ...
    //infoID, deviceID, deviceName, lastCheck, nextCheck, lastRepair, state, inspector, userID, userName, cycle
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkInfo.setInfoID(DB_CheckInfo.getID());
        infoID.setText(checkInfo.getInfoID());
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkInfo.getInfoID() == null) {
                    Toast.makeText(In_CheckInfo.this, "信息编号不能为空",
                            Toast.LENGTH_SHORT).show();
                } else if (checkInfo.getDeviceID() == null) {
                    Toast.makeText(In_CheckInfo.this, "设备编号不能为空",
                            Toast.LENGTH_SHORT).show();
                } else if(checkInfo.getInspector()==null){
                    Toast.makeText(In_CheckInfo.this, "检验人不能为空",
                            Toast.LENGTH_SHORT).show();
                }else {
                    AddCheckInfo();
                }
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                if(identity.equals("B")){
//                    Intent intent=new Intent(In_CheckInfo.this, CheckInfoList.class);
...
//                }else {
//                    startActivity(new Intent(In_CheckInfo.this, CheckInfoList.class));
//                }
                finish();
            }
        });
        selectDevice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(In_CheckInfo.this, DeviceList.class);
                Bundle bundle1 = new Bundle();
                bundle1.putInt("jump", 22);
        ...
        selectUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(In_CheckInfo.this, AccountList.class);
                Bundle bundle1 = new Bundle();
                bundle1.putInt("jump", 22);
                intent.putExtras(bundle1);
        ...
        lastCheck_Date.setOnClickListener(new View.OnClickListener() {//设置按钮的点击事件监听器
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(In_CheckInfo.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        lastCheck_Time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(In_CheckInfo.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void AddCheckInfo() {
        Runnable run = new Runnable() {
            ...
            public void run() {
                ...
                //若方法返回为true,显示添加成功
                if (DB_CheckInfo.addCheckInfo(checkInfo)) {
                    msg.what = 1001;
                } else {
                    msg.what = 1002;
                }
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1001:
                    Toast.makeText(In_CheckInfo.this, " 添加成功",
                            Toast.LENGTH_SHORT).show();
                    break;
                case 1002:
                    Toast.makeText(In_CheckInfo.this, " 添加失败",
                            Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
