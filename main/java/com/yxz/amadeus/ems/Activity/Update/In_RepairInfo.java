...
public class In_RepairInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repairInfo.setInfoID(DB_RepairInfo.getID());
        infoID.setText(repairInfo.getInfoID());
        //数据
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (repairInfo.getInfoID() == null) {
                    Toast.makeText(In_RepairInfo.this, "信息编号不能为空",
                            Toast.LENGTH_SHORT).show();
                } else if (repairInfo.getDeviceID() == null) {
                    Toast.makeText(In_RepairInfo.this, "设备编号不能为空",
                            Toast.LENGTH_SHORT).show();
                }else if (repairInfo.getUserID()==null){
                    Toast.makeText(In_RepairInfo.this, "维修负责人不能为空",
                            Toast.LENGTH_SHORT).show();
                }else {
                    AddRepairInfo();
                }
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                if(identity.equals("B")){
//                    Intent intent=new Intent(In_RepairInfo.this, RepairInfoList.class);
...
//                }else {
//                    startActivity(new Intent(In_RepairInfo.this, RepairInfoList.class));
//                }
                loading();
                finish();
            }
        ...
        selectDevice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(In_RepairInfo.this, DeviceList.class);
        ...
        selectUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(In_RepairInfo.this, AccountList.class);
                Bundle bundle1 = new Bundle();
                bundle1.putInt("jump", 32);
                intent.putExtras(bundle1);
        ...
        damageDate_Date.setOnClickListener(new View.OnClickListener() {//设置按钮的点击事件监听器
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(In_RepairInfo.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        damageDate_Time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(In_RepairInfo.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    private void AddRepairInfo() {
        Runnable run = new Runnable() {
            ...
            public void run() {
                ...
                //若方法返回为true,显示添加成功
                if (DB_RepairInfo.addRepairInfo(repairInfo)) {
                    msg.what = 1001;
                } else {
                    msg.what = 1002;
                }
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1001:
                    Toast.makeText(In_RepairInfo.this, " 添加成功",
                            Toast.LENGTH_SHORT).show();
                    break;
                case 1002:
                    Toast.makeText(In_RepairInfo.this, " 添加失败",
                            Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
